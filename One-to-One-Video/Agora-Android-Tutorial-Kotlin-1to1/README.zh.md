...
该项目使用了 [Kotlin](https://kotlinlang.org) 语言来实现，你可以在这里找到使用 **Java** 的项目：[Agora-Android-Tutorial-1to1](https://github.com/AgoraIO/Agora-Android-Tutorial-1to1)
...
## 运行环境
- Android Studio 3.1+ 或者 IntelliJ IDEA 2018.2+
...
- 如果发现了示例代码的 bug, 欢迎提交 [issue](https://github.com/AgoraIO/Agora-Android-Tutorial-Kotlin-1to1/issues)

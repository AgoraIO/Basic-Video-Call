...
本开源项目使用 **Swift** 语言，你可以在这里找到使用 **Objective-C** 的项目：[Agora-macOS-Tutorial-Objective-C-1to1](https://github.com/AgoraIO/Agora-macOS-Tutorial-Objective-C-1to1)
...
- 如果发现了示例代码的 bug, 欢迎提交 [issue](https://github.com/AgoraIO/Agora-macOS-Tutorial-Swift-1to1/issues)
